...
public class GuildCategory extends GuildChannel {
    ...
    public GuildCategory(DiscordClient client, long id, Guild guild, String name, int position, List<PermissionOverwrite> permissionOverwrites) {
        super(client, id, guild, name, position, permissionOverwrites, -1);
    }

    public GuildCategory(DiscordClient client, long id, long guildId, String name, int position, List<PermissionOverwrite> permissionOverwrites) {
