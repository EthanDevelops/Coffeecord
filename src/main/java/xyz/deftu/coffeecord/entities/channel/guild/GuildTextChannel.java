...
public class GuildTextChannel extends GuildChannel {
    ...
    public GuildTextChannel(DiscordClient client, long id, Guild guild, String name, int position, List<GuildPermission> permissionOverwrites, long parentId, int cooldown, boolean nsfw, String topic) {
    ...
    public GuildTextChannel(DiscordClient client, long id, long guildId, String name, int position, List<GuildPermission> permissionOverwrites, long parentId, int cooldown, boolean nsfw, String topic) {
